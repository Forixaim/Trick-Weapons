...
public class BattleAnimations extends BattleStylesAnimation
{
	...
	protected void Build()
	{
		...
		IMPERATRICE_SWORD_JAB1 = new BasicAttackAnimation(0.0f, 0.0f, 0.2f, 0.4f, 0.6f, null, biped.toolR, "battle_style/legendary/imperatrice_lumiere/sword/jab1", biped)
		...
		IMPERATRICE_SWORD_JAB4 = new BasicAttackAnimation(0.0f, 0.0f, 0.2f, 0.3f, 0.4f, null, biped.toolR, "battle_style/legendary/imperatrice_lumiere/sword/jab4", biped)
				...
				.addProperty(AnimationProperty.AttackPhaseProperty.IMPACT_MODIFIER, ValueModifier.setter(5f))
				.addProperty(AnimationProperty.StaticAnimationProperty.PLAY_SPEED_MODIFIER, Animations.ReusableSources.CONSTANT_ONE);
		IMPERATRICE_SWORD_JAB5 = new BasicAttackAnimation(0.2f, 0.0f, 0.05f, 0.2f, 0.9f, null, biped.toolR, "battle_style/legendary/imperatrice_lumiere/sword/jab5", biped)
