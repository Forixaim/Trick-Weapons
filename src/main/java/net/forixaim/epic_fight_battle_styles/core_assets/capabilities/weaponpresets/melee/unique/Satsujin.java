...
public class Satsujin
{
	...
	public static Function<Pair<Style, EFBSWeaponCapability.Builder>, EFBSWeaponCapability.Builder> demonAttackCycle = (main) ->
	{
	...
	public static Function<Pair<Style, EFBSWeaponCapability.Builder>, EFBSWeaponCapability.Builder> demonSheathAttackCycle = (main) ->
	{
		EFBSWeaponCapability.Builder builder = main.getSecond();
		Style style = main.getFirst();
	...
	public static Function<Pair<Style, EFBSWeaponCapability.Builder>, EFBSWeaponCapability.Builder> defaultSheatheAttackCycle = (main) ->
	{
		EFBSWeaponCapability.Builder builder = main.getSecond();
		Style style = main.getFirst();
		builder.livingMotionModifier(style, LivingMotions.IDLE, Animations.BIPED_HOLD_UCHIGATANA_SHEATHING)
				.livingMotionModifier(style, LivingMotions.KNEEL, Animations.BIPED_HOLD_UCHIGATANA_SHEATHING)
				.livingMotionModifier(style, LivingMotions.WALK, Animations.BIPED_WALK_UCHIGATANA_SHEATHING)
				.livingMotionModifier(style, LivingMotions.CHASE, Animations.BIPED_HOLD_UCHIGATANA_SHEATHING)
				.livingMotionModifier(style, LivingMotions.RUN, Animations.BIPED_RUN_UCHIGATANA_SHEATHING)
				.livingMotionModifier(style, LivingMotions.SNEAK, Animations.BIPED_HOLD_UCHIGATANA_SHEATHING)
				.livingMotionModifier(style, LivingMotions.SWIM, Animations.BIPED_HOLD_UCHIGATANA_SHEATHING)
				.livingMotionModifier(style, LivingMotions.FLOAT, Animations.BIPED_HOLD_UCHIGATANA_SHEATHING)
				.livingMotionModifier(style, LivingMotions.FALL, Animations.BIPED_HOLD_UCHIGATANA_SHEATHING);
		builder.newStyleCombo(style,
				Animations.UCHIGATANA_SHEATHING_AUTO,
				Animations.UCHIGATANA_SHEATHING_DASH,
				Animations.UCHIGATANA_SHEATH_AIR_SLASH
		);
		builder.innateSkill(style, (itemstack) -> EpicFightSkills.BATTOJUTSU);
		return builder;
	};
}
