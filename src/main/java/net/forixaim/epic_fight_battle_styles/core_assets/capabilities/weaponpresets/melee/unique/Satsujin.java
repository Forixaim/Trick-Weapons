...
//				if (playerPatch.getSkill(SkillSlots.WEAPON_PASSIVE).getDataManager().hasData(WOMSk) && playerPatch.getSkill(SkillSlots.WEAPON_PASSIVE).getDataManager().getDataValue(SatsujinPassive.SHEATH))
//				{
