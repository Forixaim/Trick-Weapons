...
public class BattleAnimations extends BattleStylesAnimation
{
	...
	public static StaticAnimation IMPERATRICE_SWORD_TRUE_FLARE_BLADE;
	...
	protected void Build()
	{
		...
		IMPERATRICE_GUARD = new StaticAnimation(true, "battle_style/legendary/imperatrice_lumiere/sword/guard", biped)
		...
		IMPERATRICE_SWORD_JAB1 = new BasicAttackAnimation(0.05f, 0.25f, 0.4f, 0.5f, 1f, null, biped.toolR, "battle_style/legendary/imperatrice_lumiere/sword/jab1", biped)
				...
				.addProperty(AnimationProperty.StaticAnimationProperty.PLAY_SPEED_MODIFIER, (dynamicAnimation, livingEntityPatch, v, v1, v2) ->
				{
					...
					{
						if (playerPatch.getSkill(BattleArtsSkillSlots.BATTLE_STYLE).getDataManager().hasData(BattleArtsDataKeys.FLARE_BURST.get()) && (playerPatch.getSkill(BattleArtsSkillSlots.BATTLE_STYLE).getDataManager().getDataValue(BattleArtsDataKeys.FLARE_BURST.get())))
						{
							return baseSpd * 1.1f;
						}
		...
		IMPERATRICE_SWORD_INFERNO_ASTROLABE = new AttackAnimation(0.05f, "battle_style/legendary/imperatrice_lumiere/sword/combat_arts/inferno_astrolabe", biped,
				new AttackAnimation.Phase(0f, 1f, .75f, .9f, 1f, 1f, biped.rootJoint, LumiereColliders.IMPERATRICE_INFERNO_ASTROLABE),
				new AttackAnimation.Phase(1f, 1.45f, 1.05f, 1.25f, 1.45f, 1.45f, biped.rootJoint, LumiereColliders.IMPERATRICE_INFERNO_ASTROLABE),
				new AttackAnimation.Phase(1.45f, 2f, 1.6f, 1.75f, 2f, 2f, biped.rootJoint, LumiereColliders.IMPERATRICE_INFERNO_ASTROLABE),
				new AttackAnimation.Phase(2f, 2.5f, 2.1f, 2.25f, 2.5f, 2.5f, biped.rootJoint, LumiereColliders.IMPERATRICE_INFERNO_ASTROLABE),
				new AttackAnimation.Phase(2.5f, 2.6f, 2.5f, 2.6f, 4f, 4f, biped.rootJoint, LumiereColliders.IMPERATRICE_INFERNO_ASTROLABE))
				.addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER, ValueModifier.multiplier(0.35f))
				.addProperty(AnimationProperty.AttackPhaseProperty.STUN_TYPE, StunType.LONG)
				.addProperty(AnimationProperty.AttackPhaseProperty.SWING_SOUND, SoundRegistry.IMPERATRICE_SWING3.get())
				.addProperty(AnimationProperty.AttackPhaseProperty.HIT_SOUND, SoundRegistry.IMPERATRICE_HIT_M.get())
				...
				, AnimationEvent.TimeStampedEvent.create(1f, AnimationHelpers.BLINK, AnimationEvent.Side.CLIENT)
				, AnimationEvent.TimeStampedEvent.create(1.45f, AnimationHelpers.BLINK, AnimationEvent.Side.CLIENT)
				, AnimationEvent.TimeStampedEvent.create(2f, AnimationHelpers.BLINK, AnimationEvent.Side.CLIENT)
				, AnimationEvent.TimeStampedEvent.create(2.5f, AnimationHelpers.BLINK, AnimationEvent.Side.CLIENT));
		...
		IMPERATRICE_SWORD_FLARIAN_IGNITION =  new AttackAnimation(0.05f, 0.0f, 2.15f, 2.3f, 5f, LumiereColliders.IMPERATRICE_ULTIMATE_TRY, biped.rootJoint, "battle_style/legendary/imperatrice_lumiere/sword/ultimate_arts/flarian_ignition", biped)
		...
		IMPERATRICE_SWORD_DOWN_SMASH = new KnockbackAttackAnimation(0.05f, 0.4f, 0.4f, 0.5f, 1.25f, LumiereColliders.IMPERATRICE_DOWN_SMASH, biped.rootJoint, "battle_style/legendary/imperatrice_lumiere/sword/down_smash", biped, 0f, 45f)
				...
				.addEvents(
						AnimationEvent.TimeStampedEvent.create(1.1F, (entitypatch, animation, params) ->
						{
							...
							if (ModList.get().isLoaded(ExplosiveEnhancement.MODID))
							{
								...
								entity.level().addParticle(ParticleTypes.EXPLOSION_EMITTER, entity.getX(), entity.getY() + 1, entity.getZ(), Double.longBitsToDouble(entity.getId()), 0, 0);
							if (entitypatch instanceof PlayerPatch<?> playerPatch && playerPatch.getSkill(BattleArtsSkillSlots.BATTLE_STYLE).getDataManager().hasData(BattleArtsDataKeys.HEAT.get()))
							{
								if (!playerPatch.isLogicalClient())
								{
									playerPatch.getSkill(BattleArtsSkillSlots.BATTLE_STYLE).getDataManager().setDataSync(BattleArtsDataKeys.HEAT.get(), 1000f, (ServerPlayer) playerPatch.getOriginal());
									playerPatch.getSkill(BattleArtsSkillSlots.BATTLE_STYLE).getDataManager().setDataSync(BattleArtsDataKeys.FLARE_BURST.get(), true, (ServerPlayer) playerPatch.getOriginal());
		...
		IMPERATRICE_SWORD_FTILT = new BasicAttackAnimation(0.1f, 0.0f, 0.01f, 0.03f, 0.27f, null, biped.toolR, "battle_style/legendary/imperatrice_lumiere/sword/forward_tilt", biped)
				...
				.addProperty(AnimationProperty.StaticAnimationProperty.FIXED_HEAD_ROTATION, true)
				.addState(EntityState.TURNING_LOCKED, true);
		IMPERATRICE_SWORD_CERCLE_DE_FEU = new KnockbackAttackAnimation(0.1f, 0.0f, 0.12f, 0.15f, 2.75f, null, biped.toolR, "battle_style/legendary/imperatrice_lumiere/sword/forward_tilt_2", biped, 2f, 2f)
		...
		IMPERATRICE_SWORD_SOLAR_FLARE = new KnockbackAttackAnimation(0.1f, 0.0f, 0.05f, 0.15f, 2.75f, null, biped.toolR, "battle_style/legendary/imperatrice_lumiere/sword/solar_flare", biped, 2f, 2f)
				.addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER, ValueModifier.multiplier(1f))
				.addProperty(AnimationProperty.AttackPhaseProperty.STUN_TYPE, StunType.LONG)
				.addProperty(AnimationProperty.AttackPhaseProperty.SWING_SOUND, SoundRegistry.IMPERATRICE_SWING3.get())
				.addProperty(AnimationProperty.AttackPhaseProperty.HIT_SOUND, SoundRegistry.IMPERATRICE_HIT_FINISHER.get())
		...
		IMPERATRICE_SWORD_NEUTRAL_AERIAL = new KnockbackAttackAnimation(0.0f, "battle_style/legendary/imperatrice_lumiere/sword/neutral_aerial", biped, 2f, 2f,
				new KnockbackAttackAnimation.KnockbackPhase(0.0f, 0.0f, 0.1f, 0.2f, 0.2f, 0.2f, biped.rootJoint, LumiereColliders.IMPERATRICE_NEUTRAL_AERIAL, 2f, 2f),
				new KnockbackAttackAnimation.KnockbackPhase(0.2f, 0.0f, 0.35f, 0.4f, 0.4f, 0.4f, biped.rootJoint, LumiereColliders.IMPERATRICE_NEUTRAL_AERIAL, 2f, 2f),
				new AttackAnimation.Phase(0.4f, 0.0f, 0.5f, 0.55f, 1.2f, 1.2f, biped.rootJoint, LumiereColliders.IMPERATRICE_NEUTRAL_AERIAL))
				.addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER, ValueModifier.multiplier(0.3f))
				.addProperty(AnimationProperty.AttackPhaseProperty.STUN_TYPE, StunType.HOLD)
				.addProperty(AnimationProperty.AttackPhaseProperty.SWING_SOUND, SoundRegistry.IMPERATRICE_SWING1.get())
				.addProperty(AnimationProperty.AttackPhaseProperty.HIT_SOUND, SoundRegistry.IMPERATRICE_HIT_S.get())
		...
		IMPERATRICE_SWORD_FORWARD_AERIAL = new KnockbackAttackAnimation(0.2f, "battle_style/legendary/imperatrice_lumiere/sword/forward_aerial", biped, 2f, 2f,
				new KnockbackAttackAnimation.KnockbackPhase(0.0f, 0.0f, 0.2f, 0.25f, 0.35f, 0.35f, biped.toolR, null, 2f, 2f),
				new KnockbackAttackAnimation.KnockbackPhase(0.35f, 0.0f, 0.4f, 0.45f, 0.55f, 0.55f, biped.toolR, null, 2f, 2f),
				...
				.addProperty(AnimationProperty.AttackPhaseProperty.SWING_SOUND, SoundRegistry.IMPERATRICE_SWING1.get(), 2)
				.addProperty(AnimationProperty.AttackPhaseProperty.HIT_SOUND, SoundRegistry.IMPERATRICE_HIT_S.get(), 2)
				.addProperty(AnimationProperty.AttackPhaseProperty.IMPACT_MODIFIER, ValueModifier.setter(35f), 2)
				.addProperty(AnimationProperty.ActionAnimationProperty.MOVE_VERTICAL, true)
				.addProperty(AnimationProperty.ActionAnimationProperty.STOP_MOVEMENT, false)
				.addState(EntityState.TURNING_LOCKED, true)
				.addState(EntityState.LOCKON_ROTATE, true)
		...
		IMPERATRICE_SWORD_BLAZE_STINGER = new AttackAnimation(0.05f, 0.0f, 0.3f, 0.4f, 3.4f, null, biped.toolR, "battle_style/legendary/imperatrice_lumiere/sword/chargeattack", biped)
				...
				.addState(EntityState.LOCKON_ROTATE, true)
				.addProperty(AnimationProperty.StaticAnimationProperty.PLAY_SPEED_MODIFIER, Animations.ReusableSources.CONSTANT_ONE);
		IMPERATRICE_INCANDESCENT_FIREWORK = new AttackAnimation(0.2f, 0.0f, 0.3f, 0.4f, 0.9f, null, biped.handL, "battle_style/legendary/imperatrice_lumiere/sword/combat_arts/incandescent_firework", biped)
				.addProperty(AnimationProperty.AttackPhaseProperty.DAMAGE_MODIFIER, ValueModifier.setter(1))
				.addProperty(AnimationProperty.StaticAnimationProperty.PLAY_SPEED_MODIFIER, Animations.ReusableSources.CONSTANT_ONE)
				.addEvents(AnimationEvent.TimeStampedEvent.create(0.7f, AnimationHelpers.SHOOT_FIREWISP, AnimationEvent.Side.SERVER));
